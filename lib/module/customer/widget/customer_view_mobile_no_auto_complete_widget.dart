...
class CustomerViewDetailsMobileAutoCompleteWidget extends StatelessWidget {
  final CustomerController controller;
  const CustomerViewDetailsMobileAutoCompleteWidget({
    super.key,
          ...
          children: [
            ...
            Container(
              ...
              child: TextFormField(
                ...
                onChanged: (val) {
                  controller.mobileController.text = val;
                  customMessageOrErrorPrint(
                    message: controller.mobileController.text,
                  );
                },
              ),
            ),
