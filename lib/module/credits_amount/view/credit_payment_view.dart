...
class CreditPaymentView extends GetView<SellListAfterScanController> {
  ...
  Widget build(BuildContext context) {
    ...
    print('CreditPaymentView creditId: ${arguments.id}');
    print('CreditPaymentView customer_id: ${arguments.customerId}');
    print('CreditPaymentView user_id: ${arguments.userId}');
    return CommonAppbar(
