...
class UserModelData {
  ...
  UserModelData.fromJson(Map<String, dynamic> json) {
    ...
    pAddBankDetails = json['p_add_bank_details'];
    pEditProfile = json['p_edit_profile'];
    pCreateGrn = json['p_create_grn'];
    pApproveGrn = json['p_approve_grn'];
    pViewGrn = json['p_view_grn'];
    pReturnExchange = json['p_return_exchange'];
    role = json['role'] != null ? Role.fromJson(json['role']) : null;
    staffName = json['staff_name'];
    staffNumber = json['staff_number'];
    staffMobile = json['staff_mobile'];
    staffEmail = json['staff_email'];
    staffEmailId = json['staff_email_id'];
    childName = json['child_name'];
    childMobile = json['child_mobile'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['p_add_bank_details'] = pAddBankDetails;
    data['p_edit_profile'] = pEditProfile;
    data['p_create_grn'] = pCreateGrn;
    data['p_approve_grn'] = pApproveGrn;
    data['p_view_grn'] = pViewGrn;
    data['p_return_exchange'] = pReturnExchange;
    if (role != null) {
      data['role'] = role!.toJson();
    }
    data['staff_name'] = staffName;
    data['staff_number'] = staffNumber;
    data['staff_mobile'] = staffMobile;
    data['staff_email'] = staffEmail;
    data['staff_email_id'] = staffEmailId;
    data['child_name'] = childName;
    data['child_mobile'] = childMobile;
